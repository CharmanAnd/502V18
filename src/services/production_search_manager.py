...
class MentalDriversArchitect:
    ...
    def _load_telemedicine_templates(self) -> Dict[str, Any]:
        """Carrega templates específicos para telemedicina"""
        return {
            'medicina': {
    ...
    def _validate_story_quality(self, historia: str) -> bool:
        ...
        # 1. Verifica comprimento mínimo
        if len(historia) < self.quality_filters['min_story_length']:
